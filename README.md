...
```sh
docker build -t job_tapir .
docker run -p 8080:80 job_tapir
# open http://localhost:8080
```

## Questions? Issues?

The [GitHub repo for this template is here](https://github.com/robconery/job_tapir). I don't have discussions enabled, but feel free to pop an issue if you like or, better yet, a PR!
